...
import io.github.lumkit.lint.desktop.app.generated.resources.alert_payload_dumper
import io.github.lumkit.lint.desktop.app.generated.resources.format_payload_part_tooltips
import io.github.lumkit.lint.desktop.app.generated.resources.ic_dismiss
import io.github.lumkit.lint.desktop.app.generated.resources.label_payload_output_path
import io.github.lumkit.lint.desktop.app.generated.resources.label_payload_path
import io.github.lumkit.lint.desktop.app.generated.resources.text_cancel
import io.github.lumkit.lint.desktop.app.generated.resources.text_choose_dir
import io.github.lumkit.lint.desktop.app.generated.resources.text_choose_file
import io.github.lumkit.lint.desktop.app.generated.resources.text_choose_file_payload
import io.github.lumkit.lint.desktop.app.generated.resources.text_confirm
import io.github.lumkit.lint.desktop.app.generated.resources.text_derive_images
import io.github.lumkit.lint.desktop.app.generated.resources.text_no_data
import io.github.lumkit.lint.desktop.app.generated.resources.text_please_choose_a_bin_file
import io.github.lumkit.lint.desktop.app.generated.resources.text_search_image
import io.github.lumkit.lint.desktop.app.generated.resources.text_select_all
                    ...
                    coroutineScope.launch {
                        chooseFile(
                            ...
                            fileFilter = FileNameExtensionFilter(
                                getString(Res.string.text_choose_file_payload),
                                "bin"
                            ),
                        )?.let {
                            ...
                            if (outputPath.value.text.trim().isEmpty()) {
                                payloadDumperViewModel.setOutputPath(
                                    TextFieldValue(
                                        text = File(it.parent, "images").absolutePath,
                                        selection = TextRange(absolutePath.length)
                                    )
                                )
                            }
...
private fun ColumnScope.Parts(
    ...
    val parts = payloadDumperViewModel.parts.collectAsState()
    val selectParts = payloadDumperViewModel.selectedParts.collectAsState()
    val listColumns = LocalGridColumns.current
